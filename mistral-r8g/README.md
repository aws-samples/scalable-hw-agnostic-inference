...
## Nodepool
```
cat memory-optimized-nodepool.yaml | envsubst | kubectl apply -f -
```
...
```
cat mistral-r8g-deploy.yaml | envsubst | kubectl apply -f -
```
...
```
kubectl apply -f mistral-r8g-svc.yaml
```
...
```
kubectl apply -f mistral-r8g-ing.yaml
```
